...
class HelpTab(QWidget):
    ...
    def setup_ui(self):
        ...
        <p><b>2. 导入模板（docx、odt格式）</b>：在“模板与输入区设置”中添加模板文件，双击打开、编辑模板文件。</p>
        <p><b>3. 定义输入区</b>：在“输入区（表单）”部分设置需要填写的字段（如“名称”、“地址”等）。</p>
        <p><b>4. 字段映射</b>：您可以复制字段的<b>ID</b>（例如 <code>“名称”</code>），然后双击打开模板，将带有大括号的<code>“{{名称}}”</code> 复制到指定的位置，用户完成信息填写后，程序会自动检索该字段并替换。</p>
        ...
        <p style="text-align: right;">2026-01-06</p>
        """
